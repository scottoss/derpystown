...
export function createIslandMap(world: World, instanced: boolean, template = false): ServerMap {
	...
	add (entities.plank1(16.00, 21.50));
add (entities.plank1(14.00, 21.50));
add (entities.plank1(14.00, 22.13));
add (entities.plank1(16.00, 22.17));
add (entities.plank1(14.00, 20.83));
add (entities.plank1(16.09, 20.83));
